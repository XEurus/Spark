...
from spark_tasks.data.can import CAN_SPRITE_CFG, CAN_FANTA_CFG
from spark_tasks.data.container import CONTAINER_PLASTIC_CFG
...
class ObjectTableSceneCfg(object_table_env_cfg.ObjectTableSceneCfg):
    ...
    can_sprite_2: RigidObjectCfg = CAN_SPRITE_CFG.replace(
