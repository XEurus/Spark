...
class TerminationsCfg:
    ...
    success = DoneTerm(
        func=mdp.task_done_insert_cans,
        params={
            ...
            "z_above_container": 0.05,  # can must be within container_z + this offset
        },
    )
...
class EventCfg:
    ...
    reset_insert_cans = EventTerm(
        func=mdp.reset_insert_cans_objects,
        mode="reset",
        params={
            "can1_cfg": SceneEntityCfg("can_fanta_1"),
            "can2_cfg": SceneEntityCfg("can_fanta_2"),
